...
router.get("/", async (req, res) => {
  const myquery = "SELECT * FROM pan_certificates ORDER BY date DESC";
...
router.get("/:certificateid", async (req, res) => {
  ...
  const myquery = "SELECT * FROM pan_certificates WHERE certificateid=?";
...
router.patch("/status", async (req, res) => {
  ...
  const myquery =
    "SELECT * FROM pan_certificates WHERE iscomplete=? ORDER BY date DESC";
  const singleUser = new Promise(async (resolve, reject) => {
...
router.put("/:certificateid", async (req, res) => {
  const { certificateid } = req.params;
  const myquery = "UPDATE pan_certificates SET ? WHERE certificateid = ?";
...
router.get("/single/:userid", async (req, res) => {
  ...
  const myquery =
    "SELECT * FROM pan_certificates WHERE userid=? ORDER BY date DESC";
  const singleUser = new Promise(async (resolve, reject) => {
...
router.put("/cancel/:id", async (req, res) => {
  const { id } = req.params;
  const myquery = "UPDATE pan_certificates SET ? WHERE id = ?";
  const updateUser = new Promise(async (resolve, reject) => {
...
router.delete("/:id", async (req, res) => {
  const { id } = req.params;
  const myquery = "DELETE FROM pan_certificates WHERE id= ?";
  const updateUser = new Promise(async (resolve, reject) => {
