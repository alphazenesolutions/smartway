...
router.patch("/status", async (req, res) => {
  ...
  const myquery =
    "SELECT * FROM all_certificates WHERE iscomplete=? ORDER BY date DESC";
  const singleUser = new Promise(async (resolve, reject) => {
...
router.get("/single/:userid", async (req, res) => {
  ...
  const myquery =
    "SELECT * FROM all_certificates WHERE userid=? ORDER BY date DESC";
  const singleUser = new Promise(async (resolve, reject) => {
...
router.put("/cancel/:id", async (req, res) => {
  const { id } = req.params;
  const myquery = "UPDATE all_certificates SET ? WHERE id = ?";
  const updateUser = new Promise(async (resolve, reject) => {
