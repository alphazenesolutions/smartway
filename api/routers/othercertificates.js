...
router.get("/", async (req, res) => {
  const myquery = "SELECT * FROM other_certificates ORDER BY date DESC";
...
router.get("/single/:userid", async (req, res) => {
  ...
  const myquery =
    "SELECT * FROM other_certificates WHERE userid=? ORDER BY date DESC";
...
router.get("/:certificateid", async (req, res) => {
  ...
  const myquery = "SELECT * FROM other_certificates WHERE certificateid=?";
  const singleUser = new Promise(async (resolve, reject) => {
...
router.patch("/status", async (req, res) => {
  ...
  const myquery =
    "SELECT * FROM other_certificates WHERE iscomplete=? ORDER BY date DESC";
  const singleUser = new Promise(async (resolve, reject) => {
...
router.put("/:certificateid", async (req, res) => {
  const { certificateid } = req.params;
  const myquery = "UPDATE other_certificates SET ? WHERE certificateid = ?";
...
router.put("/cancel/:id", async (req, res) => {
  const { id } = req.params;
  const myquery = "UPDATE other_certificates SET ? WHERE id = ?";
  const updateUser = new Promise(async (resolve, reject) => {
...
router.delete("/:id", async (req, res) => {
  const { id } = req.params;
  const myquery = "DELETE FROM other_certificates WHERE id= ?";
  const updateUser = new Promise(async (resolve, reject) => {
